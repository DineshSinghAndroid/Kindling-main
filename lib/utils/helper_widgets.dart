...
Container CourseCard(String courseImage,String courseTitle,String coursePrice) {
  return Container(
    width: 192.w,
    child: Column(
      mainAxisSize: MainAxisSize.min,
      ...
      children: [
        Container(height: 134,width: 192,decoration: BoxDecoration(image: DecorationImage(image: AssetImage(courseImage))),),
        8.height,
        Text(courseTitle,style: AppTextStyles.textSize12WithWeight500Black,),
        4.height,
        Text(coursePrice,style: AppTextStyles.textSize13WithWeight500Black,)
      ],
    ),
  );
}
...
InkWell gridContainer(String icon,Color iconColor,Color iconBackGroundColor,String title , onTap) {
  return InkWell(
    onTap: onTap,
    child: Container(
      width: 188.w,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            10.height,
            Text(title,style: AppTextStyles.textSize16WithWeight500Black,),
            8.height,
          ],
        ),
      ),

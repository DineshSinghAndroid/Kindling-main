...
Future<dynamic> multiPart(String endPoint, BuildContext context, Map<String, String> params,
    List<String> filePaths, String mediaName) async {
    ...
    try {
      ...
      try {
        ...
        log("RESPONSE: STATUSCODE :- ${response.statusCode
            .toString()} Url :- ${url}  RESPONSE :- ${utf8.decode(
            responseByteArray).toString() ??
            ""}");
